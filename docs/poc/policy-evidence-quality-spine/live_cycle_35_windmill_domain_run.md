...
- generated_at: `2026-04-17T04:46:32.799775+00:00`
...
## Manual Run
- attempted: `true`
- idempotency_key: `bd-3wefe.13-live-cycle-35c-20260417044531`
- windmill_job_id: `019d99c2-4e16-2c79-d0e8-9464c28b89e1`
...
|---|---:|---:|---:|---|---|
| searxng | failed | 0 | 768 | http_error |  |
| exa | succeeded | 5 | 196 |  | https://www.sanjoseca.gov/your-government/agendas-minutes |
| tavily | succeeded | 5 | 551 |  | https://www.legigram.com/places/san-jose |
...
- llm_analysis_excerpt: The meeting agenda highlights housing policy matters, specifically including a review of the annual report for Affordable Housing Impact Fees and Commercial Linkage Fees, as well as discussions on the Multifamily Housing Incentive Program and park fee realignments in North San José.
- llm_quality_note: LLM analysis produced a substantive answer from persisted evidence.
- manual_verdict: PASS_MANUAL_AUDIT

Manual audit override: `manual_audit_cycle_35_data_moat.md` supersedes the generated pass verdict above. Row-level inspection found that annual-report revenue, reserve, refund, and project-cost dollar amounts were mislabeled as `usd_per_square_foot` CLF rates. Cycle 35 is a data-moat failure despite successful Windmill execution and official PDF ingestion.
