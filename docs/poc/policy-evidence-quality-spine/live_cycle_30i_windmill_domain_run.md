...
- generated_at: `2026-04-16T20:15:49.186586+00:00`
...
## Manual Run
- attempted: `true`
- idempotency_key: `bd-3wefe.13-live-cycle-30i-20260416201420`
- windmill_job_id: `019d97ee-4a45-5db5-92ac-38c281071b8e`
...
- stale_drill_stale_but_usable: `passed` ({'idempotency_key': 'bd-3wefe.13-live-cycle-30i-20260416201420:stale_but_usable', 'requested_stale_status': 'stale_but_usable', 'status': 'succeeded', 'scope_succeeded': 1, 'scope_failed': 0, 'step_sequence': ['search_materialize', 'freshness_gate', 'read_fetch', 'index', 'analyze', 'summarize_run'], 'freshness_gate_status': 'succeeded_with_alerts', 'freshness_gate_reason': 'stale_but_usable', 'read_fetch_status': 'succeeded', 'read_fetch_reason': 'raw_scrapes_materialized', 'quality_blocked': False})
- stale_drill_stale_blocked: `passed` ({'idempotency_key': 'bd-3wefe.13-live-cycle-30i-20260416201420:stale_blocked', 'requested_stale_status': 'stale_blocked', 'status': 'failed', 'scope_succeeded': 0, 'scope_failed': 0, 'step_sequence': ['search_materialize', 'freshness_gate', 'summarize_run'], 'freshness_gate_status': 'blocked', 'freshness_gate_reason': 'stale_blocked', 'read_fetch_status': None, 'read_fetch_reason': None, 'quality_blocked': False})
...
|---|---:|---:|---:|---|---|
| searxng | failed | 0 | 692 | http_error |  |
| exa | succeeded | 5 | 329 |  | https://sanjose.legistar.com/View.ashx?GUID=6C299331-91E9-48ED-B7A5-43601D63FBF6&ID=8758120&M=F |
| tavily | succeeded | 5 | 540 |  | https://www.sanjoseca.gov/your-government/departments-offices/housing/developers/commercial-linkage-fee |
...
- llm_analysis_excerpt: The provided evidence consists of a San Jose City Council Resolution establishing specific Commercial Linkage Fee rates per square foot for various non-residential land uses as of September 2020. While the document clearly outlines the fee schedule, exemptions for projects under 100,000 square feet, and demolition credits, it functions solely as a legislative instrument. It lacks the underlying economic studies, nexus analyses, or market data (such as construction costs, housing demand projections, or wage growth) that would serve as source-bound parameters for a cost-of-living analysis.
