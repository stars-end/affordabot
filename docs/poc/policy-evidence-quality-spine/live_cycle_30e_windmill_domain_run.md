...
- generated_at: `2026-04-16T19:51:43.548120+00:00`
...
## Manual Run
- attempted: `true`
- idempotency_key: `bd-3wefe.13-live-cycle-30e-20260416195007`
- windmill_job_id: `019d97d8-1e00-3ce9-5d6e-50c62649035c`
...
|---|---:|---:|---:|---|---|
| searxng | failed | 0 | 837 | http_error |  |
| exa | succeeded | 5 | 331 |  | https://records.sanjoseca.gov/Resolutions/RES80069.pdf |
| tavily | succeeded | 5 | 596 |  | https://www.sanjoseca.gov/your-government/departments-offices/housing/developers/commercial-linkage-fee |
...
- llm_analysis_excerpt: The Commercial Linkage Fee (CLF) is a one-time impact fee applied to non-residential developments in San José to fund affordable housing for low to moderate-income households. Fees are calculated based on four geographic subareas, are established in a separate Fee Resolution, and are adjusted annually via the ENR Construction Cost Index.
