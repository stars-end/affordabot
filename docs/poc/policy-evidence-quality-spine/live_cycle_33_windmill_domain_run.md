...
- generated_at: `2026-04-17T03:46:58.136768+00:00`
...
## Manual Run
- attempted: `true`
- idempotency_key: `bd-3wefe.13-live-cycle-33-20260417034400`
- windmill_job_id: `019d998a-828c-2565-8c34-54f084a2d8fa`
...
- stale_drill_stale_but_usable: `passed` ({'idempotency_key': 'bd-3wefe.13-live-cycle-33-20260417034400:stale_but_usable', 'requested_stale_status': 'stale_but_usable', 'status': 'succeeded', 'scope_succeeded': 1, 'scope_failed': 0, 'step_sequence': ['search_materialize', 'freshness_gate', 'read_fetch', 'index', 'analyze', 'summarize_run'], 'freshness_gate_status': 'succeeded_with_alerts', 'freshness_gate_reason': 'stale_but_usable', 'read_fetch_status': 'succeeded', 'read_fetch_reason': 'raw_scrapes_materialized', 'quality_blocked': False})
- stale_drill_stale_blocked: `passed` ({'idempotency_key': 'bd-3wefe.13-live-cycle-33-20260417034400:stale_blocked', 'requested_stale_status': 'stale_blocked', 'status': 'failed', 'scope_succeeded': 0, 'scope_failed': 0, 'step_sequence': ['search_materialize', 'freshness_gate', 'summarize_run'], 'freshness_gate_status': 'blocked', 'freshness_gate_reason': 'stale_blocked', 'read_fetch_status': None, 'read_fetch_reason': None, 'quality_blocked': False})
...
|---|---:|---:|---:|---|---|
| searxng | failed | 0 | 833 | http_error |  |
| exa | succeeded | 5 | 1286 |  | https://www.sanjoseca.gov/Home/Components/News/News/1683/4765 |
| tavily | succeeded | 5 | 481 |  | https://www.sanjoseca.gov/your-government/departments-offices/housing/developers/commercial-linkage-fee |
...
- llm_analysis_excerpt: The provided evidence is a summary document regarding the administrative process for implementing a Commercial Linkage Fee in San Jose. It describes the completion of two supporting studies—a Nexus Analysis to determine legal support for the fee and a Feasibility Analysis to assess economic impacts via pro forma modeling. While the text indicates that underlying economic assumptions were adjusted for COVID-19, it does not disclose the specific source-bound economic parameters or data values required to independently verify or conduct a decision-grade cost-of-living analysis.
