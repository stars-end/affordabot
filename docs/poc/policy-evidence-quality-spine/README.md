...
- `manual_audit_cycle_42_data_moat.md`
- `manual_audit_cycle_43_data_moat.md`
...
- adaptive cycle budget up to `80`
...
poetry run python scripts/verification/verify_policy_evidence_quality_spine_economics.py --max-cycles 80
