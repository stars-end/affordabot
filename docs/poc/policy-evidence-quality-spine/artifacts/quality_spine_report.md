...
- generated_at: `2026-04-15T18:22:26.108775+00:00`
...
| --- | --- | --- |
| scraped/search | pass | Scraped provenance present with provider/query/candidate rank. |
...
| storage/read-back | pass | Storage readback proven via MinIO probe and package row persistence. |
| Windmill/orchestration | not_proven | Windmill run identifiers not found in provided matrix payload. |
...
| LLM narrative | not_proven | Deterministic lane only; live LLM narrative quality not executed. |
