...
- generated_at: `2026-04-16T19:43:58.840859+00:00`
...
## Manual Run
- attempted: `true`
- idempotency_key: `bd-3wefe.13-live-cycle-30d-20260416194226`
- windmill_job_id: `019d97d1-156b-e66d-fa7a-9e8e9a89e57e`
...
- stale_drill_stale_but_usable: `passed` ({'idempotency_key': 'bd-3wefe.13-live-cycle-30d-20260416194226:stale_but_usable', 'requested_stale_status': 'stale_but_usable', 'status': 'succeeded', 'scope_succeeded': 1, 'scope_failed': 0, 'step_sequence': ['search_materialize', 'freshness_gate', 'read_fetch', 'index', 'analyze', 'summarize_run'], 'freshness_gate_status': 'succeeded_with_alerts', 'freshness_gate_reason': 'stale_but_usable', 'read_fetch_status': 'succeeded', 'read_fetch_reason': 'raw_scrapes_materialized', 'quality_blocked': False})
- stale_drill_stale_blocked: `passed` ({'idempotency_key': 'bd-3wefe.13-live-cycle-30d-20260416194226:stale_blocked', 'requested_stale_status': 'stale_blocked', 'status': 'failed', 'scope_succeeded': 0, 'scope_failed': 0, 'step_sequence': ['search_materialize', 'freshness_gate', 'summarize_run'], 'freshness_gate_status': 'blocked', 'freshness_gate_reason': 'stale_blocked', 'read_fetch_status': None, 'read_fetch_reason': None, 'quality_blocked': False})
...
|---|---:|---:|---:|---|---|
| searxng | failed | 0 | 702 | http_error |  |
| exa | succeeded | 5 | 1176 |  | https://records.sanjoseca.gov/Resolutions/RES80069.pdf |
| tavily | succeeded | 5 | 434 |  | https://www.sanjoseca.gov/your-government/departments-offices/housing/developers/commercial-linkage-fee |
...
## Manual Audit Notes
- reader_output_excerpt: https://www.planetizen.com/news/2020/09/110424-linkage-fee-affordable-housing-funding-approved-san-jose: Linkage Fee for Affordable Housing Funding Approved in San Jose | Planetizen News Skip to main content Advertise with us ![Image 1: Home](https://www.planetizen.com/themes/custom/plnz4/logo.svg) Planetizen search - News LATEST NEWS Study: Automobile Dependency Reduces Life Satisfaction RECOMMENDED Seattle Legalizes Co-Living A new state law requires all Washington cities to allow co-living facilities in areas zoned for multifamily housing. RECOMMENDED NYC Officials Announce Broadway Pedestrianiz
...
- llm_analysis_excerpt: The evidence outlines San Jose's newly approved commercial linkage fee structure, including specific rates, units of measurement, and an exemption option for developers, but it does not contain information regarding economic handoff readiness.
