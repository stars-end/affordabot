...
## Manual Run
- attempted: `true`
- idempotency_key: `bd-3wefe.13-live-cycle-32-20260417031252`
- windmill_job_id: `019d996d-76cf-c910-b7a1-dca180a1f45a`
...
- pgvector_index_probe: `passed` (document_chunks rows found with embeddings (10422))
...
- stale_drill_stale_but_usable: `passed` ({'idempotency_key': 'bd-3wefe.13-live-cycle-32-20260417031252:stale_but_usable', 'requested_stale_status': 'stale_but_usable', 'status': 'succeeded', 'scope_succeeded': 1, 'scope_failed': 0, 'step_sequence': ['search_materialize', 'freshness_gate', 'read_fetch', 'index', 'analyze', 'summarize_run'], 'freshness_gate_status': 'succeeded_with_alerts', 'freshness_gate_reason': 'stale_but_usable', 'read_fetch_status': 'succeeded', 'read_fetch_reason': 'raw_scrapes_materialized', 'quality_blocked': False})
- stale_drill_stale_blocked: `passed` ({'idempotency_key': 'bd-3wefe.13-live-cycle-32-20260417031252:stale_blocked', 'requested_stale_status': 'stale_blocked', 'status': 'failed', 'scope_succeeded': 0, 'scope_failed': 0, 'step_sequence': ['search_materialize', 'freshness_gate', 'summarize_run'], 'freshness_gate_status': 'blocked', 'freshness_gate_reason': 'stale_blocked', 'read_fetch_status': None, 'read_fetch_reason': None, 'quality_blocked': False})
...
|---|---:|---:|---:|---|---|
| searxng | failed | 0 | 653 | http_error |  |
| exa | succeeded | 5 | 1093 |  | https://sanjosespotlight.com/after-years-of-debate-san-jose-releases-study-on-commercial-developement-fees/ |
| tavily | succeeded | 5 | 529 |  | https://www.sanjoseca.gov/your-government/departments-offices/housing/developers/commercial-linkage-fee |

## DB/Storage Evidence
- probe_status: `queried`
- search_snapshot_rows: `1`
- content_artifact_rows: `20`
- raw_scrape_rows: `24`
- document_chunks_count: `10422`
- document_chunks_with_embedding_count: `10422`
- minio_object_checks: `[{'uri': 'artifacts/2026-04-13.windmill-domain.v1/San Jose CA/meeting_minutes/reader_output/7d7e37d44cb7ad8b0723c6bdcaf9f767438d8b8b0d26c4e168fcc159351fe138.md', 'status': 'not_probeable_without_storage_client'}, {'uri': 'artifacts/2026-04-13.windmill-domain.v1/San Jose CA/meeting_minutes/reader_output/9297ca10ba891b810bedf8ed6b4bf0ddd7e96aea09cc4c79f28955e95b590afb.md', 'status': 'not_probeable_without_storage_client'}, {'uri': 'artifacts/2026-04-13.windmill-domain.v1/San Jose CA/meeting_minutes/reader_output/3ce76f23289d3a26eab6bced4dda0aa20f45dfcf8ca652b9de3bd967a410745f.md', 'status': 'not_probeable_without_storage_client'}]`

## Manual Audit Notes
- reader_output_excerpt: https://www.hcd.ca.gov/housing-elements/docs/los altos_5th_draft011415.pdf: CITY OF LOS ALTOS# Draft 2015 –2023 Housing Element City CouncilMegan Satterlee, MayorJan Pepper, Mayor Pro TemJeannie Bruins, CouncilmemberVal Carpenter, CouncilmemberJarrett Fishpaw, Councilmember## Planning and Transportation CommissionRonit Bodner, ChairMalika Junaid, Vice ChairJonathan Baer, CommissionerPhoebe Bressack, CommissionerKen Lorell, CommissionerMichael McTighe, CommissionerJerry Moison, Commissioner## Community Development DepartmentJames Walgren, AICP, Assistant City ManagerDavi
- reader_quality_note: Reader output was persisted and provided to analysis.
- llm_analysis_excerpt: Economic analysis failed closed because the canonical LLM provider was unavailable.
