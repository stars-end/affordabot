...
- generated_at: `2026-04-16T19:57:33.449665+00:00`
...
## Manual Run
- attempted: `true`
- idempotency_key: `bd-3wefe.13-live-cycle-30f-20260416195611`
- windmill_job_id: `019d97dd-ab21-b4b6-8b3a-bb6c5e836cbf`
...
| exa | succeeded | 5 | 222 |  | https://records.sanjoseca.gov/Resolutions/RES80069.pdf |
...
- llm_analysis_excerpt: The provided evidence outlines the Commercial Linkage Fee (CLF) in San José as a one-time impact fee on non-residential development to fund affordable housing. It indicates that rates are based on four geographic subareas and adjusted annually via the ENR Construction Cost Index. However, the text does not provide the specific dollar amounts, exact unit metrics, or detailed exemption lists.
