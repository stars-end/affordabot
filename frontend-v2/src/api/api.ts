const API_BASE_URL = import.meta.env.VITE_API_URL || 'https://backend-production-c383.up.railway.app';
...
export async function scrapeJurisdiction(jurisdiction: Jurisdiction): Promise<{ success: boolean }> {
...
export async function getLegislation(jurisdiction: Jurisdiction, limit: number = 10): Promise<Bill[]> {
